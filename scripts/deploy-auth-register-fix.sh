...
# Deploy Auth Service Register Fix to Production
# Fixes optionalAuthenticate middleware to use correct JWT verification

set -e

echo "🚀 Deploying Auth Service Register Fix to Production..."
echo "====================================="
echo ""
...
echo "  ✅ optionalAuthenticate now uses verifyAccessToken()"
echo "  ✅ Uses correct JWT_SECRET from jwt.js config"
echo "  ✅ Validates issuer ('hrms-backend') and audience ('hrms-frontend')"
echo "  ✅ Properly sets req.user with _id and id"
echo ""
echo -e "${BLUE}🧪 Test Register Endpoint:${NC}"
echo "  POST /api/auth/register"
echo "  Headers: Authorization: Bearer <token>, x-tenant-id: <tenantId>"
echo ""
...
echo "  1. Test register endpoint with valid token"
echo "  2. Run onboarding script: node scripts/onboarding-backend-complete.js"
echo "  3. Verify register returns 201 instead of 401"
echo ""
