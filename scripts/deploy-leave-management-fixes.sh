...
# Deploy HR Service with Leave Management Fixes to Production
# This script builds, pushes, and deploys the HR service with all leave management fixes

set -e

echo "=========================================="
echo "🚀 Deploying HR Service - Leave Management Fixes"
echo "=========================================="
...
echo -e "   Run: node scripts/test-leave-both-tenants.js"
echo ""
