...
// Database connection - Use production Cosmos DB
// IMPORTANT: This will create the user in PRODUCTION database
// Use global MONGODB_URI environment variable
const MONGO_URI = process.env.MONGODB_URI || process.env.MONGO_URI || 'mongodb://etelios-mongo-db:h4cmg34pAbKZxyZRqwqxa2PhWoZ9ux5quvBZh2EqhSIaGrPMAaF8btIdgoMawHILafZBw8YgsddlACDbbpOoJQ==@etelios-mongo-db.mongo.cosmos.azure.com:10255/?ssl=true&replicaSet=globaldb&retrywrites=false&maxIdleTimeMS=120000&appName=@etelios-mongo-db@';
...
async function connectDB() {
  try {
    ...
    await mongoose.connect(mongoUri, {
      ...
      serverSelectionTimeoutMS: 30000, // Increased timeout for Cosmos DB
      socketTimeoutMS: 45000,
      connectTimeoutMS: 30000,
      retryWrites: false, // Cosmos DB connection string says retrywrites=false
    ...
    if (error.message.includes('authentication') || error.message.includes('Invalid key')) {
      ...
      console.error('   💡 Solution: Check Azure Cosmos DB network access settings');
    }
